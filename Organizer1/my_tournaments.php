...
if ($isAdmin) {
    ...
    $stmt = $conn->prepare("SELECT * FROM tournaments WHERE LOWER(created_by)=LOWER(?) ORDER BY event_date DESC, event_time DESC, id DESC");
...
<head>
    ...
    <style>
        ...
        .topbar { background:linear-gradient(180deg,#e6a04b 0%,#c97f2e 100%); padding:10px 20px; color:#fff; display:flex; justify-content:space-between; align-items:center; }
        ...
        h1 { margin:0 0 14px; font-family:"Bebas Neue",sans-serif; font-size:52px; color:#9f5d22; letter-spacing:1px; }
        ...
        .sport { font-size:10px; letter-spacing:1px; text-transform:uppercase; color:#a56a2f; font-weight:700; margin-bottom:4px; }
        ...
        .quick a, .quick button { font:inherit; font-size:11px; font-weight:700; text-align:center; border-radius:8px; padding:8px 6px; border:1px solid #e2b68f; text-decoration:none; color:#8e5b2a; background:#fff; cursor:pointer; }
        .quick .primary { background:linear-gradient(120deg,#e1a051,#bf7427); color:#fff; border:none; }
