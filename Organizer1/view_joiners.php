...
<head>
    ...
    <style>
        ...
        .navbar { background:linear-gradient(180deg,#e6a04b 0%,#c97f2e 100%); color:#fff; padding:12px 18px; display:flex; justify-content:space-between; align-items:center; }
        ...
        .btn { display:inline-block; text-decoration:none; background:#fff; border:1px solid #e2b68f; color:#8e5b2a; border-radius:8px; padding:8px 10px; font-weight:700; font-size:12px; }
