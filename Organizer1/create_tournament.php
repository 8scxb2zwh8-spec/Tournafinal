...
<head>
    ...
    <style>
        body { font-family:"Plus Jakarta Sans","Segoe UI",sans-serif; background:linear-gradient(180deg,#fffdf9 0%,#fff6ec 55%,#f4f6fa 100%); margin:0; }
        .container { max-width: 96vw !important; width: 96vw !important; margin:0 auto; padding:24px 16px 34px; }
        .layout { display:flex; gap:14px; align-items:flex-start; width:100% !important; }
        .form-card { flex:1 1 auto; min-width:0; width: calc(100% - 300px) !important; }
        .preview-card { flex:0 0 280px; width:280px !important; }
        .card {
            width: 100%;
            max-width: none;
            ...
            border-radius:16px;
            box-shadow:0 12px 24px rgba(183,121,46,.10);
            padding:22px;
        }
        ...
        input:focus, textarea:focus { outline:none; border-color:#de9a4a; box-shadow:0 0 0 3px rgba(222,154,74,.16); }
        .row { display:grid; grid-template-columns:1fr 1fr; gap:10px; }
        .row-3 { display:grid; grid-template-columns:1fr 1fr 1fr; gap:10px; }
        .btn { border:none; border-radius:10px; padding:12px 18px; font-weight:700; color:#fff; background:linear-gradient(120deg,#e5a14a,#cf7f2a); cursor:pointer; }
        .sub { color:#4f5663; margin-top:0; }
        .preview-card h3 { margin-top:0; }
        .preview-chip { display:inline-block; border-radius:999px; padding:4px 8px; font-size:11px; font-weight:700; background:#fdf2e3; color:#9b611f; }
        ...
        .picker-search { margin-top:8px; display:grid; grid-template-columns:1fr auto; gap:8px; }
        .picker-search input { width:100%; }
        .loc-btn { margin-top:0; border:1px solid #d4d9e1; background:#fff; border-radius:8px; padding:8px 10px; font-weight:700; cursor:pointer; white-space:nowrap; }
        .sport-tag { display:inline-block; background:#fdf2e3; color:#9b611f; padding:7px 12px; border-radius:999px; font-weight:700; margin-bottom:10px; }
        @media (max-width:1020px) { .layout { display:block; } .preview-card { width:auto; } }
        @media (max-width:700px) { .row, .row-3 { grid-template-columns:1fr; } .picker-search { grid-template-columns:1fr; } }
    </style>
</head>
<body>
<div class="navbar">
        ...
        <section class="card form-card">
            ...
            <form action="save_tournament.php" method="POST" id="tournamentForm">
                ...
                <div class="input-group">
                    ...
                    <textarea id="f_description" name="description" rows="3" required></textarea>
                </div>
                <div class="row-3">
                    <div class="input-group">
                        <label>Date</label>
