...
<head>
    ...
    <style>
        :root { --ink:#23170f; --surface:#fff; --line:#e8d8c7; --accent:#d08a35; --accent-deep:#b86b1f; }
        * { box-sizing: border-box; }
        body { margin:0; color:var(--ink); font-family:"Manrope","Segoe UI",sans-serif; background:#fffbf7; }
