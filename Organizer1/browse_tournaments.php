...
<head>
    ...
    <style>
        body { margin:0; font-family:"Manrope","Segoe UI",sans-serif; background:#fffbf7; color:#2b1c11; }
        .topbar { background:linear-gradient(180deg,#e6a04b 0%,#c97f2e 100%); padding:10px 20px; color:#fff; display:flex; justify-content:space-between; align-items:center; gap:12px; }
        ...
        .home-btn { border:1px solid #be7a2f; background:#e4a359; color:#fff; text-decoration:none; border-radius:999px; padding:7px 11px; font-size:12px; font-weight:700; }
        ...
        .search-wrap i { position:absolute; right:12px; top:50%; transform:translateY(-50%); color:#b9772f; font-size:13px; }
        .title-row { display:flex; justify-content:space-between; align-items:center; margin-bottom:14px; gap:12px; }
        .title-row h1 { margin:0; font-family:"Bebas Neue",sans-serif; letter-spacing:1px; font-size:54px; line-height:0.95; color:#9f5d22; }
        ...
        .card-top { height:5px; background:linear-gradient(90deg,#e5b272,#d08a35); }
        .card-body { padding:12px 12px 10px; flex:1; display:flex; flex-direction:column; }
        .sport { font-size:10px; letter-spacing:1px; text-transform:uppercase; color:#a56a2f; font-weight:700; margin-bottom:3px; }
        ...
        .btn { border:none; border-radius:8px; padding:7px 10px; font-size:11px; font-weight:700; text-decoration:none; background:linear-gradient(120deg,#e1a051,#bf7427); color:#fff; }
