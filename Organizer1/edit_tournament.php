...
<head>
    ...
    <style>
        body { font-family: "Plus Jakarta Sans", "Segoe UI", sans-serif; background:linear-gradient(180deg,#fffdf9 0%,#fff6ec 60%,#f4f6fa 100%); margin:0; }
        ...
        .card {
            ...
            border-radius:14px;
            box-shadow:0 10px 22px rgba(183,121,46,.10);
            padding:20px;
        }
        ...
        .btn.primary { background:linear-gradient(120deg,#e5a14a,#cf7f2a); color:#fff; }
        .btn.ghost { background:#fff; color:#9b611f; border:1px solid #e6c9a4; }
        .warn { border:1px solid #e6c9a4; background:#fff8ef; color:#875424; padding:10px; border-radius:8px; margin-bottom:10px; }
        ...
        @media (max-width: 860px) { .row, .row-3 { grid-template-columns:1fr; } .picker-search { grid-template-columns:1fr; } }
    </style>
</head>
<body>
<div class="navbar">
